...
class AssetsService {
    ...
    processLockButtonShadowDelta(uuid) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lockButton = yield this.assetsDao.getZbLockById(uuid);
            if (!lockButton) {
            ...
            yield this.assetsDao.updateLock(lockButton);
    ...
    processLockButtonsShadow(deltaShadowLockButtons, desiredShadowLockButtons) {
        return __awaiter(this, void 0, void 0, function* () {
            console.log('assets.service processLockButtonsShadow in: ' + JSON.stringify({ deltaShadowLockButtons, desiredShadowLockButtons }));
            const promises = Object.keys(deltaShadowLockButtons).map((uuid) => __awaiter(this, void 0, void 0, function* () {
                const entry = desiredShadowLockButtons[uuid];
                if (entry) {
                    try {
                        if (entry.action === 'UPDATE') {
                            yield this.processLockButtonShadowDelta(uuid);
                        }
    ...
    unlockByMemberDetected(memberDetectedItem) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!(cameraItem === null || cameraItem === void 0 ? void 0 : cameraItem.locks)) {
    ...
    handleLockStopEvent(event) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const stopPromises = Object.keys(lock.cameras).map((cameraAssetId) => __awaiter(this, void 0, void 0, function* () {
                const camera = lock.cameras[cameraAssetId];
